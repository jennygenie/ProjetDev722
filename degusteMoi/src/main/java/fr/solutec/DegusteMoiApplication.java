...
public class DegusteMoiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "Siwertz", "Marius", "siwertzm", "123", null, null);
		User u2 = new User(null, "Bardin", "Marion", "mbardin", "456", null, null);
		User u3 = new User(null, "Scoliege", "Paul", "poloscolo", "789", null, null);
		User u4 = new User(null, "aa", "aa", "aa", "aa", null, null);
		userRepos.save(u1);
		userRepos.save(u2);
		userRepos.save(u3);
		userRepos.save(u4);
